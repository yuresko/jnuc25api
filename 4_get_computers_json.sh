...
#    run: sh /path/to/this/file/4_get_computers_json.sh
#    
#    example: sh /Users/jonathan/Downloads/4_get_computers_json.sh
...
# Command to retrieve all computers using bearer token auth. Data type: JSON.
curl -s -H "Authorization: Bearer ${bearerToken}" -H "accept: application/json" "$url"/JSSResource/computers -X GET
